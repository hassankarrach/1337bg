...
const StyledPoolerItem = styled.div<PoolerItemProps>`
  width: 100px;
  height: ${(props) =>
    props.rank == 1 ? "300px" : props.rank == 2 ? "270px" : "230px"};
    ...
    <StyledPoolerItem avatar={avatar} rank={rank}>
      ...
      <div className="PromoAvatar">
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 314.587 314.587"
          enable-background="new 0 0 314.587 314.587"
          className="Left_svg"
        >
          <g>
...
const Top3 = () => {
  ...
  useEffect(() => {
    if (top_med_pooler && top_kh_pooler && top_bg_pooler) {
      ...
      const rankOrder: Record<number, number> = { 2: 0, 1: 1, 3: 2 };
      rankedPoolers.sort((a, b) => {
        const aRank = a.rank as number;
        const bRank = b.rank as number;
